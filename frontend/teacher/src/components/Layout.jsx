...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      {/* Top navbar */}
      <header className="fixed left-64 right-0 top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white/90 px-7 shadow-sm backdrop-blur">
