      ...
      <aside className="fixed left-0 top-0 h-screen w-60 bg-blue-900 flex flex-col z-30">
        ...
        <div className="px-5 py-5 border-b border-blue-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-bold text-sm leading-tight">AI English</p>
        ...
        <div className="px-4 py-4 border-t border-blue-800">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white text-sm font-medium truncate">{user?.username || 'Teacher'}</p>
              <p className="text-blue-400 text-xs truncate">{user?.email}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-blue-300 hover:bg-blue-800 hover:text-white transition text-sm"
          >
