...
const navItems = [
  ...
  { to: '/ocr', label: 'OCR Workspace', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 7a2 2 0 012-2h3l1.5 2H19a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm5 3v4m2-2H6m8-1h4m-4 3h4"/></svg> },
  ...
  { to: '/analytics', label: 'Analytics', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg> },
  { to: '/profile', label: 'Profile', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg> },
];
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      {/* Sidebar */}
      <aside className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-white to-[#f8f5f0] flex flex-col z-30 border-r border-amber-100/70 shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
        {/* Brand */}
        <div className="px-6 py-5 border-b border-amber-100/70">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-white shadow-[0_2px_8px_rgba(0,0,0,0.05)] ring-1 ring-amber-100/70 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs">Teacher Portal</p>
            </div>
          </div>
        </div>
        ...
        {/* User footer */}
        <div className="px-5 py-4 border-t border-amber-100/70">
